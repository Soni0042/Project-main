...
function RentPage() {
  ...
  useEffect(() => {
    fetch("http://localhost:3000/api/properties/rent") // endpoint for rent
      .then((res) => res.json())
      .then((data) => {
  ...
  if (loading) return <p style={styles.loading}>Loading rental properties...</p>;
  if (error) return <p style={styles.error}>Error: {error}</p>;

  return (
    <div style={styles.container}>
      <h1 style={styles.heading}>Rent Properties</h1>
